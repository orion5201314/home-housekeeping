...
use app\common\controller\BaseLikeStaffController;

class BaseStaffController extends BaseLikeStaffController
{
    ...
    public function initialize()
    {
        ...
        if (isset($this->request->staffInfo) && $this->request->staffInfo) {
            ...
            $this->staffId = $this->request->staffInfo['staff_id'];
        }
    }
}